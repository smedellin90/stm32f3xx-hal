...
// The LSE runs at 32 768 hertz unless an external clock is provided
...
impl Rtc {
    ...
    /// make function for Wakeup Timer clock source selection
    /// 000: RTC/16 clock selected
    /// 001: RTC/8 clock selected
    /// 010: RTC/4 clock selected
    /// 011: RTC/2 clock selected
